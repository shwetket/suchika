...
- Wealth, Health, Household: schema + contract ready, **zero Java code**
- Gateway: only profile proxied
- Frontend: page stubs exist, no API wiring for wealth/health/household
