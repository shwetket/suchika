...
*Context:* `EPIC8_IMPLEMENTATION_PLAN.md` Phase 4 flags this as an architecture decision deferred to Phase 4 planning time, not a product owner call — listed here only so it is not forgotten.
*Options:* N/A — placeholder for re-review at Phase 4 start, not requiring a product owner answer now.
