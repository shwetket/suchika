...
class TransactionResourceTest {
    ...
    void listTransactions_returns200_withTransactionList() {
        ...
        Response response = resource.listTransactions(ACCOUNT_ID, PROFILE_ID, "2026-01-01", "2026-01-31", "CREDIT");
    ...
    void listTransactions_invalidFromDate_throwsBadRequest() {
        assertThrows(BadRequestException.class,
                () -> resource.listTransactions(ACCOUNT_ID, PROFILE_ID, "not-a-date", null, null));
    }

    @Test
    void listTransactions_invalidTxnType_throwsBadRequest() {
        assertThrows(BadRequestException.class,
                () -> resource.listTransactions(ACCOUNT_ID, PROFILE_ID, null, null, "NOT_A_TYPE"));
    }
