...
- Supported platforms now include Codespaces (DevContainer node configurations).
- Ensure detailed seed data is used for tests, as per recent automation upgrades.
- Be aware of newly added DevOps automation scripts (like `clean-unwanted.ps1`) and maintain operational documentation.
...
| — | `clean-unwanted` | Remove unwanted log and review files at root |
